    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editFormData) {
                ...
                if (formData.vehicleImage) {
                    endpoint = `http://localhost:8080/api/vehicle/image/upload/${editFormData.vehicleId}`;
                                        ...
                                        <div className="admin-vehicle-card-image-view">
                                            {vehicle.vehicleImage && (
                                                <img
                                                    ...
                                                    onClick={() => openImageInNewTab(`http://localhost:8080/api/vehicle/image/${vehicle.vehicleImage}`)}
